        ...
        return(
            ...
            <article className="ContentAbtMe col-lg-9">
                ...
                <div className="row rowProFile">
                    ...
                    <div className="inProfileCol"><input className="inFName" aria-required="true" id="pepBD" type="text" value="23/11/1998" onChange={this.onTodoChange}/></div>
                </div>
                <div className="row rowProFile">
                    <aside className="txtProfileCol"><label htmlFor="pepAdd">Địa chỉ</label></aside>
                    <div className="inProfileCol"><input className="inFName" aria-required="true" id="pepAdd" type="text" value="Tây Ninh " onChange={this.onTodoChange}/></div>
                </div>
                <div className="row rowProFile ">
                    <aside className="txtProfileCol "><label htmlFor="pepEmail ">Email</label></aside>
                    <div className="inProfileCol "><input className="inFName"  id="pepEmail" name="email" type="text" value={this.state.email} onChange={this.onTodoChange}/></div>
                </div>
                <div className="row rowProFile ">
