...
router.route('/users/follow').put(controllerUser.addFollowing,controllerUser.addFollower);
router.route('/users/unFollow').put(controllerUser.removeFollowing, controllerUser.removeFollower)
